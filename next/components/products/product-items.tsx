...
export const ProductItems = ({
  ...
  return (
    <div className="py-20">
      <h2 className="text-2xl md:text-4xl font-medium bg-clip-text text-transparent bg-gradient-to-b from-foreground/80 via-foreground to-foreground mb-2">
        {heading}
      </h2>
    ...
    <Link href={`/${locale}/products/${product.slug}` as never} className="group relative block">
      ...
      <div className="mt-8">
        <div className="flex justify-between">
          ...
          <span className="bg-primary text-primary-foreground shadow-lg text-xs px-2 py-1 rounded-full">
